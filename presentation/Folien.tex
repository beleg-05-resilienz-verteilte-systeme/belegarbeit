\section{Worum geht es? Auf einen Blick}
...
\begin{frame}
    \frametitle{Implementierung von Circuit-Breakern}
    \begin{itemize}
        \item Client-seitige Implementierung
        \item Dienst-seitige Implementierung
        \item Proxy-basierte Lösungen
    \end{itemize}
\end{frame}
...
\begin{frame}
    ...
    \begin{figure}[h]
        \centering
        [height=0.5\textheight]{images/retry-pattern}

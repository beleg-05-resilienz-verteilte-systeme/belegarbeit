...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item Gerne mit Bild und/oder Code %Bild nicht gut aber z.B. https://www.flip-design.de/wp-content/uploads/2011/04/SQLServerPartitionierung.png
    \end{itemize}
\end{frame}
...
\begin{frame}
    ...
    \begin{itemize}
        \item Was ist das genau?
        \item Wie funktioniert es?
        \item Gerne mit Bild und/oder Code %Bild z.B. https://www.shutterstock.com/search/scalability-logo
    \end{itemize}
\end{frame}

...
\subsection{Resilienzstrategien: Arten der Partitionierung}
\begin{frame}
    \frametitle{\insertsection}
    \framesubtitle{\insertsubsection}
  %  \begin{block}{Arten der Partitionierung}
        \begin{itemize}
...
\begin{frame}
    ...
    %scale=0.6, every node/.style={scale=0.6}
            ...
            \draw [->] (-2,0) -- (closed.west) node[midway,above] {\textit{Start}};
        \end{tikzpicture}
        \caption{Circuit Breaker Zustandsdiagramm~\cite{Montesi.19.09.2016}.}
    \end{figure}
\end{frame}
...
\note[itemize]{
\item Horizont.Skal., \textbf{Software UND Netzwerk-Red.}
}
